...
// White must move on L0 and L+1 (both T5 ○). L0: K a1, Q c1; black pawns c4 (defended by b5), king e5.
// L+1: K a1, black king e5.
...
const w = P.buildWorld({ n: 5, h: 4, m: 3, md: 0, s: 0, c: [1, 0], rows: {
	0: { st: 2, en: 10, boards: { 10: '1p2k/2p2/5/5/K1Q2' } },
