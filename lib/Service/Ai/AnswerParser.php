...
/**
 * Parses model answers (docs/SPEC.md §10.5). The move is returned as the model's raw code text; the client validates
 * it with the engine and retries once with feedback.
 */
