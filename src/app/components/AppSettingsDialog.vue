...
<!--
  The in-app settings dialog: board, quantum display, moves, animation and sound, coach and computer, and the keyboard
  shortcuts. Every change applies live and is saved with a debounce through services/preferences.js.
-->
<template>
	<NcAppSettingsDialog
		:open="open"
		...
		<NcAppSettingsSection id="qc-settings-engine" :name="t('quantumchess', 'Coach and computer')">
			<RadioRow
...
import { BOARD_THEMES, boardThemeLabel, resolveBoardTheme } from '../../board/boardThemes.js'
import { setupPosition } from '../../engine/index.js'
import { preferences, reducedMotion, setPreference } from '../../services/preferences.js'
