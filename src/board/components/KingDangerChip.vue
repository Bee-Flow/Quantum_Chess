...
<!--
  King danger, the game's "check": "Your king can be captured · 100%" in the error colour when the capture is certain, a
  warning chip below 100 %. Nothing when the king is safe.
-->
<template>
	<NcChip
		v-if="weight > 0"
