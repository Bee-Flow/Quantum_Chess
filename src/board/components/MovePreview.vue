...
<!--
  The odds card: the resolution with its icon, the outcome bar of a roll, why each outcome happens (explainOutcome), the
  king risk and the What if? button. Data from preview.js (`input.previewInfo`).
-->
<template>
