...
<!--
  A stacked bar of the outcomes of a roll in key order: Missed · Moved · Captured, or the squares of a Measure. Captured
  uses the success colour; Moved and Missed are neutral and never red.
-->
<template>
