...
<!--
  Roll transparency: one stretch per outcome and a marker at the roll, with the engine's `rollDisplay` text ("Moved
  [0.0000, 0.5000) · Captured [0.5000, 1.0000) · rolled 0.3712 → Moved").
-->
<template>
	<div class="qc-roll-bar" :class="{ 'qc-roll-bar--compact': compact }">
		...
		<p v-if="!hideText" class="qc-roll-bar__text">
			{{ text }}
		</p>
	</div>
</template>
...
const props = defineProps({
	...
	/** Hide the sentence under the bar */
