...
/**
 * Screen geometry of the board: from a square index (a1 = 0, docs/engine-rules.md §2.1) to the displayed column and row
 * for an orientation, and back; plus the SVG paths of probability rings and pies.
 */
 ...
 */
export function squareCenter(square, orientation = 'w') {
