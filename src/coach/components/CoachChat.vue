...
<!--
  The coach chat: suggested questions, answers of an LLM as safe Markdown (at most 2000 characters), and move chips
  checked with findMove. Without an LLM source, or when a request fails, the coach answers from its own analysis
  (coach/explain.js).
-->
<template>
...
import { waitForAiTask } from '../../llm/aiTasks.js'
import { useAiSources } from '../../llm/composables/useAiSources.js'
import { requestCoach } from '../../services/api.js'
import { moveChips, truncateAnswer, withoutLinks } from '../chips.js'
import { engineAnswer } from '../explain.js'
