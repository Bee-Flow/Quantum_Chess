...
<!--
  The Coach tab: the evaluation in words, the quality badge of the player's last move, threat warnings and
  opportunities, hints and the coach chat.
-->
<template>
	<div class="qc-coach" data-test="coach-panel">
		<p v-if="!coach.active.value" class="qc-coach__off">
...
import { BAD_LABELS, forMover } from '../quality.js'
