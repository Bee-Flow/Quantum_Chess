...
<!--
  Quantum budget pips (GAME-DESIGN §3.4.4): 8 small squares filled to `budget(state, colour)`. The first pip is muted
  while nothing is a ghost; at 8/8 the pips pulse once. The button opens a popover that explains the budget and names
  the ghosts that use it.
-->
<template>
...
import { reducedMotion } from './boardPreferences.js'
