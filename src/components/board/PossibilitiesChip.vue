...
<!--
  The possibilities chip (GAME-DESIGN §3.4.4): the number of complete chessboards the position could be (worldCount),
  muted "1" when everything is solid. Click or W opens the panel: the most likely possibilities as mini-boards with
  their chance (differing squares outlined), then "and N more".
-->
<template>
	<NcPopover
		:shown="open"
