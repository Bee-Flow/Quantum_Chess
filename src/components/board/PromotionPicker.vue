...
<!--
  Promotion picker (GAME-DESIGN §3.5.3): Q, R, N, B in a column over the target file, opened before the move is sent.
  Arrow keys move between the choices, Esc cancels.
-->
<template>
	<div
		class="qc-promotion"
