 ...
 * into `<symbol>`s (crisp at any size, no requests, CSP-friendly). The folder layout `img/pieces/<set>/` stays open for
 * more sets (the generated Letters set is planned for 1.1). Every piece graphic is
 * `<use href="#qc-piece-<set>-<color><TYPE>">`.
 */
