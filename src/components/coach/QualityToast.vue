...
<!--
  The quality badge of the player's latest move, shown for a few seconds next to that move's target square and
  naming the move ("d2-d4 Good"), so it never reads as a verdict on the reply or on the piece under it (Beginner:
  every move; Standard: mistakes only, GAME-DESIGN §5.3). It sits below the square (above it on the bottom rank), so
  the square's own probability badge in its top corner stays visible.
-->
<template>
...
import { squareIndex } from '../../engine/squares.js'
