...
<!--
  The controls row (GAME-DESIGN §3.1, §8.1): the move switcher with the preview text, the possibilities chip, quick
  toggles (flip, sound) and the ⋮ menu with display toggles, Settings and the game actions.
-->
<template>
...
import PossibilitiesChip from '../board/PossibilitiesChip.vue'
