...
<!--
  The game panel (GAME-DESIGN §3.1): tabs Moves · Log · Chat · Coach (chat and coach only when their slot is given)
  and the game actions.
-->
<template>
...
const tabs = computed(() => [
	...
	// TRANSLATORS: tab listing every roll of the game (RULES.md glossary: roll)
