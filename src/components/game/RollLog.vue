...
<!--
  The roll log (GAME-DESIGN §3.7): one card per roll, newest first, with the roll bar, the result sentence and
  details (weights, the rolled number, budget before and after). A card opens its ply in the history view.
-->
<template>
	<div class="qc-rolls">
		...
		<ol v-else class="qc-rolls__list">
			<li
				...
				<RollBar :record="r.entry.measurement" :showText="false" />
...
import RollBar from '../board/RollBar.vue'
import { budget, worldCount } from '../../engine/index.js'
