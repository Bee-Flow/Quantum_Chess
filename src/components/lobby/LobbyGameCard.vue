...
<!--
  One game of the lobby (GAME-DESIGN §2.3): a small board, the other player with avatar and status, a status line and
  badges; the board and the title open the game, the actions slot holds the inline buttons.
-->
<template>
...
import { colorText, otherPlayer, progressText, timeControlText } from '../../online/summaryText.js'
