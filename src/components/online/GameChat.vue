...
<!--
  The chat of an online game (GAME-DESIGN §7.11, SPEC §14.6.4): plain-text messages (never HTML), quick phrases and
  system lines shown in the reader's language, an emoji picker, and muting the opponent (muted messages collapse).
-->
<template>
...
import { PHRASE_KEYS, phraseText, systemText } from '../../online/chatText.js'
...
const opponentName = computed(() => {
	...
	return color ? c.names.value[color === 'w' ? 'b' : 'w'] : t('quantumchess', 'your opponent')
})
