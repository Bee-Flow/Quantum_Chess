...
<!--
  The panel over the board of a game that has not started (GAME-DESIGN §7.1–7.2): an invitation to accept or decline,
  the creator's waiting state with Cancel, the join screen of an open challenge (with Copy link for its creator), and
  the declined, cancelled and expired states.
-->
<template>
	<div
		class="qc-invite"
...
import { colorText, otherPlayer, timeControlText } from '../../online/summaryText.js'
 ...
 * Run an action once.
 *
 * @param {Function} fn controller action
 */
