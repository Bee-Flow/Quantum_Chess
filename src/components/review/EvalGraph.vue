...
<!--
  The evaluation graph of a review (GAME-DESIGN §5.4): White's E over the game as a light area, a dashed segment at
  each roll from the expected to the realised E (🎲), and quality dots (?! yellow, ? orange, ?? red, ✦ teal).
  Clicking a point selects that position.
-->
<template>
