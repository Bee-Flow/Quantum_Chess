...
<!--
  The leaderboard (GAME-DESIGN §7.7): rank, player, rating (provisional as "1340?"), rated games and record; the
  viewer's row is highlighted and pinned below the list when it is not in it. An optional group filter lists the
  viewer's own groups.
-->
<template>
