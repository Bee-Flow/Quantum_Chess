...
<!--
  Quantum confetti: 80 particles that first appear as two half-opacity copies, snap into one after 300 ms and then fall
  for 1500 ms. Not rendered under reduced motion (the parent decides).
-->
<template>
