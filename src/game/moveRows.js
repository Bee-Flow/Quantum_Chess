...
/**
 * Pure helpers for the move list, the move strip and the game summary of the game-over dialog.
 */

import { T } from '../engine/index.js'

/** @typedef {import('./gameController.js').MoveEntry} MoveEntry */

/**
 * Group MoveEntries into numbered rows `{number, w: {entry, index}|null, b: {entry, index}|null}`.
 *
 * @param {MoveEntry[]} moves the played moves
