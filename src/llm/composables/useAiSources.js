...
/**
 * The LLM sources the user may use (Nextcloud Assistant, the administrator's provider, the user's own key) and the
 * privacy notice before the first use of a source: `ensureNotice(source)` shows `AiNoticeDialog` once per source and
