...
/**
 * Synthesised sound effects: WebAudio only, no audio files. One master gain (volume/100 × 0.6). The AudioContext is
 * created on the first user gesture (`unlockAudio()`), as browsers require, and nothing plays before it. 5 ms attacks
 * and exponential releases avoid clicks. Durations follow the animation speed (never below 0.5×), and sounds still play
