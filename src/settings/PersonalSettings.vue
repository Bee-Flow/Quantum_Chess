...
<!--
  Personal settings → Quantum Chess (GAME-DESIGN §8.2): online play (leaderboard), notifications, and the AI
  opponent and coach (default source, my own provider, what is sent). Invite policy, block list and the data
  section are deferred to 1.1 (docs/LEAN-1.0.md).
-->
<template>
