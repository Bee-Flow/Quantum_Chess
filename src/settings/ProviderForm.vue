...
<!--
  An AI provider form (GAME-DESIGN §8.2–8.4): service preset, base URL (only for custom and local servers), model
  picker, API key and *Test connection*. Used for the organisation provider (admin) and for "My own API key".
  The parent saves; keys never come back from the server, only {hasKey, keyHint}.
-->
<template>
...
const props = defineProps({
	...
	/** Presets from the server (SPEC §7.4.8) */
