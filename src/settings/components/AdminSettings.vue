...
<!--
  Administration settings → Quantum Chess: online play, ratings, Nextcloud Assistant with its status card, the
  organisation's LLM provider (key behind the password confirmation), personal keys and local servers, limits and
  notices, and read-only diagnostics. Plain values are saved as they change.
-->
<template>
	<div class="qc-admin">
