	...
	steps: [
		{
			...
			hints: [
				() => t('quantumchess', 'A merge needs a square that both parts can reach.'),
				{ highlight: 'a3' },
				{ arrow: ['c3', 'b5'] },
			],
		...
		},
		{
			...
			accepted: ['a3|c3-b5'],
			hints: [
				() => t('quantumchess', 'Which squares does the bishop attack?'),
				{ highlight: 'f5' },
				{ arrow: ['c3', 'b5'] },
			],
			reply: { engine: 3 },
		...
		},
		{
			...
			explanation: () => t(
				'quantumchess',
				'Both parts attack h8. Each part alone hits only half the time; together they capture for certain.',
			),
		},
		{
			type: 'task',
			...
			accepted: ['d4|h5-h8'],
			hints: [
				() => t('quantumchess', 'Choose Merge and use both parts of the queen.'),
				{ highlight: 'd4' },
				{ arrow: ['d4', 'h8'] },
			],
