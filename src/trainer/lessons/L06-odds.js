...
export default {
	...
	goal: () => t(
		'quantumchess',
		'Use the preview. A ghost attacking a ghost has three results, and landing on your own maybe-piece rolls too.',
	),
	steps: [
		{
			type: 'quiz',
			...
			question: () => t(
				'quantumchess',
				'The preview of f3-e5 shows Missed 50 %, Moved 25 %, Captured 25 %. Why is Missed 50 %?',
			),
			answers: [
		...
		},
		{
			...
			accepted: ['f3-e5'],
			hints: [
				() => t('quantumchess', 'Move the f3 part of the knight to e5.'),
				{ highlight: 'f3' },
				{ arrow: ['f3', 'e5'] },
			],
			...
			branches: {
				move: () => t(
					'quantumchess',
					'Moved: your knight was on f3 and e5 was empty. The bishop is certainly on c7.',
				),
		...
		},
		{
			...
			prompt: () => t(
				'quantumchess',
				'The queen is 50 % on c6, 25 % on e6 and 25 % on g6. Find the move with the best chance to capture it.',
			),
			success: { moveIs: ['c1-c6'] },
			accepted: ['c1-c6'],
			hints: [
				() => t('quantumchess', 'Aim at the biggest share of the queen.'),
				{ highlight: 'c1' },
				{ arrow: ['c1', 'c6'] },
			],
			roll: ['move', 'capture'],
			branches: {
				move: () => t(
					'quantumchess',
					'Moved: the queen is now 50 % on e6 and 50 % on g6. The remaining possibilities are rescaled.',
				),
				capture: () => t('quantumchess', 'Captured: the queen was on c6.'),
			},
			fail: () => t(
				'quantumchess',
				'That shot had only 25 %. Which square holds the biggest share of the queen?',
			),
		},
		{
			type: 'task',
			...
			accepted: ['c1-g5'],
			hints: [
				() => t('quantumchess', 'Part of your own knight is on g5.'),
				{ highlight: 'c1' },
				{ arrow: ['c1', 'g5'] },
			],
			roll: ['miss', 'move'],
