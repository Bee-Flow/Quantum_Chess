...
/** Lesson 11: the graduation game against Wobbles with the Beginner coach. */
	...
	steps: [
		{
			...
			text: [
				() => t(
					'quantumchess',
					'Time for a real game from the start position. Wobbles, the friendliest engine, plays Black.',
				),
