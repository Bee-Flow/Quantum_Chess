...
/**
 * A tiny fake OpenAI-compatible server for end-to-end checks of the AI routes (docs/SPEC.md §10.2). It listens on
 * 127.0.0.1 only and answers like a well-behaved chess model:
 *
 ...
 * Standalone: `node tests/api/fake-openai.mjs [port]` keeps it running (for manual and browser tests).
 */
