...
/**
 * Smoke tests: the app is installed and reachable, its icons are served, every test user can open it, and the page
 * is free of console errors. They also exercise the test scaffolding itself.
 */
