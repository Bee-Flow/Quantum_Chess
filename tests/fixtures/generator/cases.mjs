...
export const EXAMPLE_SCRIPTS = [
	...
	['W7 rescale after a miss', setup('4k1n1/8/8/8/8/3P4/8/4K3 b - - 0 1'), ['g8-f6|h6', 'e1-e2', 'f6-d5|e4', 'd3-e4@u=3000000']],
	['W7 capture', setup('4k1n1/8/8/8/8/3P4/8/4K3 b - - 0 1'), ['g8-f6|h6', 'e1-e2', 'f6-d5|e4', 'd3-e4@u=13000000']],
	['W8 budget fallback', setup('4k3/8/6n1/8/8/8/8/1NBQK2R w - - 0 1', ['b1-a3|c3', 'c1-d2|e3', 'd1-b3|a4', 'g6-f4|h4']), ['h1-h8@u=9000000']],
	['W9 probe misses', setup('4k3/8/8/8/3p2n1/8/4P3/4K3 w - - 0 1', ['g4-e3|h6']), ['e2-e4@u=1']],
	['W9 double push and en passant', setup('4k3/8/8/8/3p2n1/8/4P3/4K3 w - - 0 1', ['g4-e3|h6']), ['e2-e4@u=16000000', 'd4-e3']],
	['W10 castling rights follow the state', setup('4k3/8/8/8/8/8/8/4K2R w K - 0 1'), ['h1-h3|h5', 'e8-d8', 'h3|h5-h1']],
	['W10 missed king step keeps the right', setup('4k3/8/8/8/8/8/8/4K1NR w K - 0 1', ['g1-e2|f3']), ['e1-e2@miss', 'e8-d8', 'e1-g1']],
	['W12 index order', setup('4k1n1/8/8/8/7R/3P4/8/4K3 w - - 0 1', ['g8-f6|h6', 'f6-d5|e4', 'd3-e4@miss']), ['h4-a4|h3', 'e8-d8', '?h3@u=0']],
	['W12 u = 8388608', setup('4k1n1/8/8/8/7R/3P4/8/4K3 w - - 0 1', ['g8-f6|h6', 'f6-d5|e4', 'd3-e4@miss']), ['h4-h3|a4', 'e8-d8', '?a4@u=8388608']],
	['W12 u = 8388609', setup('4k1n1/8/8/8/7R/3P4/8/4K3 w - - 0 1', ['g8-f6|h6', 'f6-d5|e4', 'd3-e4@miss']), ['h4-h3|a4', 'e8-d8', '?h3@u=8388609']],
	['W13 budget_full position', setup('4k3/8/8/8/8/6n1/8/KNBR4 w - - 0 1', ['g3-f1|h5', 'b1-a3|c3', 'c1-b2|e3']), ['d1-d2']],
	...
	['E12 enemy only where X is absent', setup('4k3/8/1n6/8/8/8/8/R3K3 b - - 0 1'), ['b6-a4|c4', 'a1-a8', 'e8-d8', 'a8-a4@u=12000000']],
	['E15 a piece never blocks itself', setup('4k3/8/8/8/8/R7/8/4K3 w - - 0 1', ['a3-a1|a4']), ['a1-a8']],
	['E20 location cap reached', setup('4k3/8/8/8/8/8/8/4K1N1 w - - 0 1'), ['g1-f3|h3', 'e8-d8', 'f3-e5|g5', 'd8-e8', 'h3-f2|f4', 'e8-d8']],
	...
	['E27 merge with a third part', setup('4k1n1/8/8/8/8/3P4/8/4K3 b - - 0 1'), ['g8-f6|h6', 'e1-e2', 'f6-d5|e4', 'e2-e1', 'd5|e4-f6']],
	...
	['E44 promotion probe', setup('7k/4P1n1/8/8/8/8/8/K7 w - - 0 1', ['g7-e8|f5']), ['e7-e8=N@miss', 'e8-d6', 'e7-e8=Q']],
	...
	['E58 king capture on ply 1200', { start: withFields(E.setupPosition({ fen: '8/8/8/8/8/8/3k4/4K3 w - - 0 1' }), { ply: 1199 }) }, ['e1-d2']],
	['E59 split/merge repetition', { start: E.initialState() }, ['g1-f3|h3', 'b8-a6|c6', 'f3|h3-g1', 'a6|c6-b8', 'g1-f3|h3', 'b8-a6|c6', 'f3|h3-g1', 'a6|c6-b8']],
	['E60 no legal move', setup('8/8/8/8/8/8/pp1p4/krb1K3 w - - 0 1'), ['e1-d1']],
	['E80 25% king shot', setup('k7/8/8/8/8/8/8/R3K3 w - - 0 1', ['a1-a3|b1', 'a3-a4|c3']), ['a4-a8@u=100', 'a8-b8', 'e1-f1']],
	...
	['E83 repetition suspended', setup('4r2k/8/8/8/8/8/8/1N2K3 b - - 0 1'), ['h8-g8', 'b1-c3', 'g8-h8', 'c3-b1', 'h8-g8', 'b1-c3', 'g8-h8', 'c3-b1', 'h8-g8']],
	['E85 a possible king capture escapes', setup('6k1/5ppp/8/6n1/8/8/8/R3K3 w - - 0 1', ['g5-f3|h3']), ['a1-a8', 'f3-e1@u=16000000']],
	['E85 a certain king capture escapes', setup('rr6/7k/8/8/8/8/8/K6R b - - 0 1'), ['h7-h8', 'h1-h8']],
	['E86 trapping move at ply 1199', { start: withFields(E.setupPosition({ fen: '6k1/5ppp/8/8/8/8/8/R3K3 w - - 0 1' }), { ply: 1198 }) }, ['a1-a8', 'g8-f8']],
]
...
export const LABELS_NL = { miss: 'Gemist', move: 'Verzet', capture: 'Geslagen', rolled: 'geworpen', forced: 'geforceerd' }
