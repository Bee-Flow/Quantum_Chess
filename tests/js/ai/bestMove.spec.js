...
/**
 * bestMove: the rules every level follows (take a certain king capture, avoid losing the king), the level
 * personalities, and the controlled randomness of the weaker levels.
 */
...
describe('bestMove: always-on rules', () => {
	...
	it('is reproducible with a seed and returns the documented result shape', () => {
...
describe('bestMove: level personalities', () => {
