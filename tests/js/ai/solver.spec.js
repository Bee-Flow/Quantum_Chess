...
const PUZZLES = [
	...
	[
		'P04',
		'forced',
		'R6k/6pp/3N4/8/8/8/8/2K5 w - - 0 1',
		['d6-f7|e8'],
		['e8-c7', 'e8-d6', 'e8-f6', 'e8-d6|c7', 'e8-f6|c7', 'e8-d6|f6', 'f7|e8-d6'],
		1,
	],
	...
	[
		'P11',
		'survive',
		'R5k1/4rppp/8/8/8/1K6/8/8 b - - 0 1',
		[],
		['e7-e1|e8', 'e7-e2|e8', 'e7-e3|e8', 'e7-e4|e8', 'e7-e5|e8', 'e7-e6|e8', 'e7-b7|e8'],
		0.5,
	],
