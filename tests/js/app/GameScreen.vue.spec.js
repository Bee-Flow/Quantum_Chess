...
/**
 * GameScreen with a fake GameController (SPEC §14.4.1, §14.6.3): cards, panel tabs (chat only with a slot), the
 * history view and the animator handshake.
 */
...
import GameScreen from '../../../src/components/game/GameScreen.vue'
import { NO_CAPABILITIES } from '../../../src/composables/gameController.js'
import { applyMove, generateMoves, initialState, moveNotation } from '../../../src/engine/index.js'

vi.mock('../../../src/sound/sound.js', () => ({ playSound: vi.fn(), configureSound: vi.fn(), startSuspense: () => () => {}, unlockAudio: vi.fn() }))
