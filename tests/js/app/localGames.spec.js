...
/**
 * localGames.js (SPEC §14.7): the roll memo (persisted before applying, same result after undo, promotions share one
 * u, a later ply is a fresh roll), replay and pruning.
 */
...
import {
	...
	rollFor,
	saveLocalGame,
} from '../../../src/services/localGames.js'
