...
/**
 * useLocalGame (SPEC §14.4.4): the computer reply with a mocked engine, the animation handshake, pass & play turns,
 * undo with the roll memo (assisted, same result), resignation and statistics only for unassisted games.
 */

import { beforeEach, describe, expect, it, vi } from 'vitest'
import { useLocalGame } from '../../../src/composables/useLocalGame.js'
import { generateMoves, setupPosition } from '../../../src/engine/index.js'
import { createLocalGame, loadLocalGame } from '../../../src/services/localGames.js'

vi.mock('../../../src/sound/sound.js', () => ({ playSound: vi.fn() }))
