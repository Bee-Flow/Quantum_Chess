...
/**
 * useLlmOpponent: retry with feedback, Balanced rejects non-✓ moves, Relaxed accepts any legal move, fallback marking,
 * index mode after 3 fallbacks in 5 AI moves, Nextcloud AI polling, errors.
 */

import { describe, expect, it, vi } from 'vitest'
import { applyMove, initialState } from '../../../src/engine/index.js'
import { fallbackCandidate, moveKind, useLlmOpponent } from '../../../src/llm/composables/useLlmOpponent.js'
import { personaById } from '../../../src/llm/personas.js'
...
vi.mock('../../../src/llm/aiTasks.js', () => ({ waitForAiTask: vi.fn() }))
