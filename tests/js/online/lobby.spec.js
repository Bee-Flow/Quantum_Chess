...
/**
 * The lobby store (SPEC §14.4.6): seeded from initial state, a 304 summary costs nothing, a changed token reloads the
 * lobby, actions reload it too, and Home makes the polling faster.
 */

import { afterEach, beforeEach, describe, expect, it, vi } from 'vitest'
import { createLobby } from '../../../src/online/lobby.js'
