...
use OCA\QuantumChess\Service\Ai\AnswerParser;
use OCA\QuantumChess\Service\Ai\PromptBuilder;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

/**
 * Golden prompts (move, retry, index mode, > 120 legal moves, coach, language names), the rules summary against
 * RULES.md, and the AnswerParser table (docs/SPEC.md §10.4, §10.5).
 */
final class PromptTest extends TestCase {
	...
	public function testRulesSummaryMatchesRulesMd(): void {
		...
		foreach (['there is no check', 'cannot escape', 'kings and pawns', 'measure', 'linked', 'captured', 'moved', 'missed', 'budget', '8'] as $phrase) {
			...
			$this->assertStringContainsString($phrase, $rules, "RULES.md mentions $phrase");
		}
	}
