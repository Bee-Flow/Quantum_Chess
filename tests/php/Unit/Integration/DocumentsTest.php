...
/**
 * Preferences limits and the trainer progress merge of SPEC §14.8.4.
 */
final class DocumentsTest extends TestCase {
	...
	public function testPreferencesAreStoredVerbatimWithinTheLimit(): void {
		$service = new PreferencesService($this->config(), $this->l());
	...
	public function testProgressLimit(): void {
		$service = new TrainerProgressService($this->config(), $this->l());
