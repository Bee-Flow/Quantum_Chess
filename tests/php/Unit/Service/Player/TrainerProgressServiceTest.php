...
final class TrainerProgressServiceTest extends TestCase {
	...
	private function docs(): array {
		return [
			[
				...
				'puzzles' => ['P01' => ['solved' => false, 'tries' => 3, 'hints' => 1, 'stars' => 0, 'at' => null]],
				'achievements' => ['first-steps' => 500],
				'counters' => ['splits' => 4, 'games' => ['won' => 1]],
				'xp' => 50,
			...
			[
				'v' => 1,
				'lessons' => [
					'L01' => ['done' => false, 'stars' => 3, 'at' => 100],
					'L02' => ['done' => true, 'stars' => 1, 'at' => 300],
				],
				'puzzles' => ['P01' => ['solved' => true, 'tries' => 1, 'hints' => 2, 'stars' => 2, 'at' => 700]],
				'achievements' => ['first-steps' => 400, 'healer' => 800],
				'counters' => ['splits' => 2, 'games' => ['won' => 3]],
				'xp' => 40,
	...
	public function testMergeIsCommutativeAndIdempotent(): void {
		...
		foreach ($docs as $a) {
			$this->assertSame(
				$canon(TrainerProgressService::mergeDocs($a, $a)),
				$canon(TrainerProgressService::mergeDocs($a, [])),
				'idempotent',
			);
			foreach ($docs as $b) {
				...
				$this->assertSame(
					$canon($ab),
					$canon(TrainerProgressService::mergeDocs($ab, $b)),
