...
final class AppSettingsTest extends TestCase {
	...
	public static function adminOutput(): array {
		return [
			...
			'stored values' => [[
				'mp_enabled' => false, 'mp_groups' => ['staff', 5, 'chess'], 'invite_expiry_days' => 100, 'open_expiry_days' => 0,
				'max_active_games' => 50, 'chat_retention_days' => 7, 'purge_finished_days' => 5, 'leaderboard_mode' => 'weird',
				'leaderboard_min_games' => 3, 'shared_enabled' => true, 'shared_daily_cap' => -1, 'shared_model_allowlist' => ['gpt-5', null],
				'shared_provider' => ['preset' => 'mistral', 'baseUrl' => 'https://api.mistral.ai/v1', 'model' => 'mistral-small-latest', 'label' => 'Team'],
				'local_allowlist' => ['http://localhost:11434/v1'], 'ai_max_output_tokens' => 99999, 'ai_privacy_notice' => 'Be nice.',
			], array_replace(self::ADMIN_DEFAULTS, [
				'mp_enabled' => false, 'mp_groups' => ['staff', 'chess'], 'invite_expiry_days' => 60, 'open_expiry_days' => 1,
				'max_active_games' => 50, 'chat_retention_days' => 7, 'purge_finished_days' => 30, 'leaderboard_mode' => 'opt-in',
				'leaderboard_min_games' => 3, 'shared_enabled' => true,
				'shared_provider' => ['preset' => 'mistral', 'kind' => 'openai', 'baseUrl' => 'https://api.mistral.ai/v1', 'model' => 'mistral-small-latest', 'label' => 'Team'],
				'shared_daily_cap' => 0, 'shared_model_allowlist' => ['gpt-5'], 'local_allowlist' => ['http://localhost:11434/v1'],
				'ai_max_output_tokens' => 4000, 'ai_privacy_notice' => 'Be nice.',
			])],
			'purging turned off' => [['purge_finished_days' => -4], array_replace(self::ADMIN_DEFAULTS, ['purge_finished_days' => 0])],
			'unknown provider preset' => [['shared_provider' => ['preset' => 'nope', 'baseUrl' => 'https://x.example.com']], self::ADMIN_DEFAULTS],
		];
	}
